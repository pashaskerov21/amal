    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">{{ __('main.volunteers') }} | {{ __('main.edit') }}</h4>
            </div>
        </div>
    </div>
    <div class="card">
                ...
                <div class="row">
                    <div class="col-12 col-lg-6">
                        <ul class="nav nav-pills bg-nav-pills nav-justified mb-3">
                            @foreach ($volunteer->getTranslate as $index => $translate)
                                <li class="nav-item">
                        ...
                        @if ($volunteer->image)
                            <div class='row border my-3 py-2 w-100 mx-auto'>
                                <div class="col-6 d-flex justify-content-start align-items-center">
                                    <img src="{{ asset('storage/uploads/volunteers/' . $volunteer->image) }}" width="100" height="100" alt='' style="object-fit: contain" />
                                </div>
                                <div class="col-6 d-flex justify-content-end align-items-center">
                                    <a href="{{ asset('storage/uploads/volunteers/' . $volunteer->image) }}" data-fancybox="" class="btn btn-primary">
