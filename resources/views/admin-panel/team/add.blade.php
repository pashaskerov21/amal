    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                <h4 class="page-title">{{ __('main.about') }} | {{ __('main.our_team') }} | {{ __('main.add') }}</h4>
            </div>
        </div>
    </div>
    <div class="card">
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane show active" id="tab_az">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">{{ __('main.subtitle') }} az</label>
                            ...
                            <div class="tab-pane" id="tab_en">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">{{ __('main.subtitle') }} en</label>
                                    <input type="text" class="form-control" name="subtitle[]">
                                </div>
                            </div>
                            <div class="tab-pane" id="tab_ru">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">{{ __('main.subtitle') }} ru</label>
                                    <input type="text" class="form-control" name="subtitle[]">
                                </div>
                            </div>
                        </div>
