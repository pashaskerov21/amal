<section class="home-about-section" style="background-image: url('{{asset('front-assets/images/OBJECTS.png')}}'),  url('{{asset('front-asset/images/heart-bg.png')}}');">
    <div class="container">
        <div class="row justify-content-center" style="gap: 50px;">
            ...
            <div class="col-lg-6 animate__animated animate__fadeInRight animate__delay-2">
                <div class="about-title">
                    ...
                    <div class="subtitle">
                        {{ $about->getTranslate->where('lang', Session('lang'))->first()->home_title }}</div>
                </div>
                <div class="about-text">
                    {!! $about->getTranslate->where('lang', Session('lang'))->first()->home_text !!}
                </div>
                <a href="{{route('about_'.Session('lang'))}}" class="about-btn">{{ __('main.etrafli_bax') }} <img
                        src="{{ asset('front-assets/images/arrow-svg.svg') }}" alt="arrow"></a>
            </div>
        </div>
    </div>
</section>
